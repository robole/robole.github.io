...
published: true
---
When creating a REST API, good documentation is important for people to learn about your API, and to use it without any headaches! [Swagger](https://swagger.io/) provides a specification that generates documentation dynamically from based on your code (usually controllers), and allows you to test the API in the browser. I will use it with Spring Boot and Springfox.
