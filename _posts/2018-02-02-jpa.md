...
published: true
---
The Java Persistence API (JPA) is the java community specification for persisting data between objects and a database. It was introduced to help form a standard with the emergence of different Object Relational Mapping (ORM)📦🗺️ frameworks.
