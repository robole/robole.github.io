...
published: true
---
The Java Persistence API (JPA) is the java community specification for persisting data between objects and a database. It was introduced to help form a standard with the emergence of different Object Relational Mapping (ORM) frameworks. The JPA 2.1 specification was released 22 April 2013, JPA 2.2 is a maintenance release that was approved on 19 June 2017.
