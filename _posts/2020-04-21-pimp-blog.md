...
The performance of our code can be improved. There are 2 parts of our code that make it perform sub-optimally.
...
Debouncing regulates the rate at which a function is executed over time. 

Essentially, we want to limit how often the scroll event handler updates the progress bar.
...
You can see the comparsion from Google Devtools below. Looking at the highlighted marks, you can see the optimized version of our code spends far less time repainting than the original.

<img src="/assets/img/blog/2020-04-21-pimp-blog/performance.png"  alt="performance comparsion in chrome devtools" style="display:block;width:100%;max-width:687px;margin:0 auto;"/>
